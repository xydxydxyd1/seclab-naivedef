# Tests whether relative position matters in priority, with added filler text
...
# Read riding_hood.txt
current_dir = Path(__file__).parent
resources_path = current_dir.parent / 'resources' / 'riding_hood.txt'
